...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (count($errorMessages) > 0) {
        ...
        $sql = "update bookscategory set book_category='$category' where id = " . $id;
...
# Fetch Data to id . 
$sql  = "select * from bookscategory where id = " . $id;
    ...
    <form action="edit.php?id=<?php echo $FetchedData['id']; ?>" method="POST" class="  col-8 mx-auto mt-5 d-flex align-items-center flex-column  p-4 ps-0 " enctype="multipart/form-data">
        ...
        <div class="col-12 col-lg-7 m-3 mx-auto">
            <div class=" form-floating">
                <input value="<?php echo $FetchedData['book_category']; ?>" type="text" class="form-control" id="floatingInput" placeholder="Enter Category" name="Category">
